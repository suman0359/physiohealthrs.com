...
<html lang="en">
    ...
    <body>
        ...
        <header id="header">
            <hgroup>
                <h1 class="site_title"><a href="<?php echo base_url(); ?>user_dashboard">Website Admin</a></h1>
        ...
        <section id="secondary_bar">
            ...
            <div class="breadcrumbs_container">
                <article class="breadcrumbs"><a href="<?php echo base_url(); ?>user_dashboard">Website Admin</a> <div class="breadcrumb_divider"></div> <a class="current">Dashboard</a></article>
            </div>
        ...
        <aside id="sidebar" class="column">
            ...
            <h3>Content</h3>
            <ul class="toggle">
                <li class="icn_new_article"><a href="<?php echo base_url(); ?>user_dashboard/create_article">New Article</a></li>
                <li class="icn_tags"><a href="<?php echo base_url(); ?>user_dashboard/view_all_article/<?php echo $this->session->userdata('user_id'); ?>">View All Article</a></li>
            ...
            <h3>Admin</h3>
            <ul class="toggle">
                <li class="icn_security"><a href="<?php echo base_url(); ?>user_dashboard/change_password">Change Password</a></li>
                <li class="icn_jump_back"><a href="<?php echo base_url(); ?>user_login/logout ">Logout</a></li>
            </ul>
        </ul>
