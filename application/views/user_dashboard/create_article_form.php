...
<article class="module width_full">
    ...
    <form action="<?php echo base_url();?>create_and_manage/save_blog_post" method="post" enctype="multipart/form-data">
    <div class="module_content">
        <fieldset>
            <label>Post Title</label>
            <input type="text" name="blog_title" maxlength="255">
        </fieldset>
        <fieldset>
            <label>Post Description</label>
            <textarea name="blog_description" cols="10" rows="15"></textarea>
        </fieldset>
        ...
        <input type="hidden" name="blog_menu_link" value="open_voice" />
        ...
        <input type="hidden" name="blog_creator_user_id" value="<?php echo $this->session->userdata('user_id'); ?>" />
        <fieldset class="divide_form">
            <label>Post Status</label>
            <input type="radio" name="blog_publication_status" value="1" />Published <br/>
            <input type="radio" name="blog_publication_status" value="0" />Unpublished
        </fieldset>
        <div class="clear"></div>
    </div>
    <footer>
