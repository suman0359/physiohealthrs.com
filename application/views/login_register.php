<fieldset style="border: none; ">
	<legend style="border-bottom: 1px solid #ddd;"><p>To Post in The Open Voice Register First</p></legend>
    ...
    <form action="<?php echo base_url(); ?>user_login/check_user_login" method="POST">
        ...
        <legend style="margin-top: 6px; text-decoration: underline; font-size: 12px;">
