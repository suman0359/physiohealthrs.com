<div id="content_read_more"> <!-- Start From Here Center Container -->
    <div id="body_title"><h2>All News by Ascending</h2></div>
        <div class="title_head">
            <p class="title_news" name="<?php echo $show_post->blog_title; ?>" title="<?php echo $show_post->blog_title; ?>"><?php echo $show_post->blog_title; ?></p>
            <div class="title_content">

                <p><span><?php echo $show_post->create_date_time; ?></span></p>
            ...
            <div class="social_btn">
                <ul>
                    ...
                    <li>
                        <div class="fb-comments" data-href="<?php echo base_url(uri_string()); ?>" data-width="700" data-numposts="5" data-colorscheme="light"></div>
                    </li>
                </ul>
